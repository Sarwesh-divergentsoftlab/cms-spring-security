...
<body>
	...
	<form action="doctor">
		<button type="submit" formaction="CRUDpatient/show">Show All Patient</button>
		<button type="submit" formaction="CRUDpatient/addprescription">Add prescription</button>
