...
public class CRUDpatientController {
	...
	public String addPrescrition(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		Patient patient = new Patient();
		patient.setPatient_id(req.getParameter("id"));
		patient.setPrescription(req.getParameter("info"));
		patientService.updatePescription(patient);
		return null;
	}
	...
	public String showaddPrescrition()
	{
